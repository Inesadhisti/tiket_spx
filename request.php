            ...
            <table width="100%" class="table table-striped table-bordered" id="tabeldata">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td style="vertical-align:center;"><input type="checkbox" value="<?php echo $row['no_tiket'] ?>" name="checkbox[]" /></td>
                            ...
                            <td class="text-center" style="vertical-align:middle;">
                                ...
                                <a href="request-ubah.php?id=<?php echo $row['no_tiket'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>

                                <a href="request-hapus.php?id=<?php echo $row['no_tiket'] ?>" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            </td>
