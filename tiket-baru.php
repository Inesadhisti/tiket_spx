...
?>
		...
		<div class="row">
		  ...
		  <ol class="breadcrumb">
			  ...
			  <li><a href="tiket.php"><span class="fa fa-wrench"></span> Data Tiket</a></li>
			  <li class="active"><span class="fa fa-clone"></span> Tambah Data Tiket</li>
			</ol>
		  	<p style="margin-bottom:10px;">
		  		<strong style="font-size:18pt;"><span class="fa fa-wrench"></span> Tambah Data Tiket</strong>
		  	</p>
