		...
		<div class="panel-body">
			    ...
			    <form method="post">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="nama_mekanik" name="nama_mekanik" required oninvalid="this.setCustomValidity('Nama mekanik tidak boleh kosong')" oninput="setCustomValidity('')" value="<?php echo $eks->nama_mekanik; ?>">
				  </div>
