...
(23, 'B1234ABC', 'Blindvan', 'Superco', 'None', '3200', 'servis rutin', '12-Jan-2023', 'Closed'),
...
(27, 'qwer', 'Blindvan', 'ascscsc', 'Muhidin', 'km uni', 'keluhan 2', 'awxwsx', 'Open'),
(28, 'qwercef', 'CDE', 'acwf', 'Muhidin', 'dwfewf', 'sdfghj', 'ceder', 'Requested');
...
(2, 'B9073SCL', 'CDD BOX', 'Erfan Alif Yanuar', 'None', '30452', 'Kopling agak seret dan berat,SERVICE RUTIN,KOPLING KERAS/BERAT', '10-3-2022', 'Requested'),
...
(10, 'B9376SCJ', 'CDD BOX', 'M FIRDAUS RAKA SYIFFA', 'Tamher Firman', '135885', 'GANTI BAN LUAR', '10-10-2022', 'Open'),
...
INSERT INTO `user` (`no_user`, `username`, `nama_user`, `password`, `tipe_user`) VALUES
(1, 'ali', 'Aulia Arif Dwi M', '1844156d4166d94387f1a4ad031ca5fa', 'admin'),
(2, 'iadhisti', 'Ines Adhisti', 'b29b1de827ef626d07210f0a2713f782', 'admin'),
(3, 'riyanto', 'Riyanto Panjaitan', '6932c612f0e994d2c05a772e60704818', 'admin'),
(4, 'husni', 'Husni Umar', 'f1ce54f00816db32b94f882b148e90ac', 'admin'),
(5, 'fikri', 'Fikri', '7a300492e3ca07066206b3921730fd4d', 'admin'),
(6, 'unyung', 'unyung20', '827ccb0eea8a706c4c34a16891f84e7b', 'admin'),
(7, 'test', 'Test', '202cb962ac59075b964b07152d234b70', 'admin'),
(8, 'driver', 'driver', '202cb962ac59075b964b07152d234b70', 'driver'),
(9, 'driver2', 'Driver', '202cb962ac59075b964b07152d234b70', 'driver');
...
--
ALTER TABLE `request`
  MODIFY `no_request` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `user`
  MODIFY `no_user` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
